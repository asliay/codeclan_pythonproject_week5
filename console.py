...
tango = Album("Tango in the Night", fleetwood_mac, "Pop Rock", 20.00, 12.00, "1987", "https://is3-ssl.mzstatic.com/image/thumb/Music111/v4/28/a6/a9/28a6a9f9-7040-37e3-cef9-ef6f8ecaabfa/source/600x600bb.jpg", 4, warner)
album_repository.save(tango)

mirage = Album("Mirage", fleetwood_mac, "Soft Rock", 20.00, 12.00, "1982", "https://is2-ssl.mzstatic.com/image/thumb/Music18/v4/30/5e/e2/305ee2d4-1520-4490-cd46-2336009989b1/source/600x600bb.jpg", 0, warner)
...
rumours = Album("Rumours", fleetwood_mac, "Folk Rock", 20.00, 12.00, "1977", "https://is2-ssl.mzstatic.com/image/thumb/Music/v4/8e/75/28/8e752885-66d0-737c-11ef-4c706672997e/source/600x600bb.jpg", 5, warner)
album_repository.save(rumours)

fleetwood_self_titled = Album("Fleetwood Mac", fleetwood_mac, "Soft Rock", 20.00, 12.00, "1975", "https://cdn.shopify.com/s/files/1/2976/0132/products/3749712_540x.jpg?v=1598653825", 3, warner)
album_repository.save(fleetwood_self_titled)

# # Frightened Rabbit Albums
panic_attack = Album("Painting of a Panic Attack", frightened_rabbit, "Indie Rock", 21.99, 13.19, "2016", "https://is2-ssl.mzstatic.com/image/thumb/Music69/v4/a7/28/c5/a728c5a3-d583-e646-5eaa-0ad2b3b85d41/source/600x600bb.jpg", 6, atlantic)
album_repository.save(panic_attack)

pedestrian = Album("Pedestrian Verse", frightened_rabbit, "Indie Rock", 19.99, 11.99, "2013", "https://is1-ssl.mzstatic.com/image/thumb/Music/v4/fc/9e/24/fc9e2421-bc95-29cd-4fe4-d0d570c22c84/source/600x600bb.jpg", 1, atlantic)
album_repository.save(pedestrian)

midnight = Album("Midnight Organ Fight", frightened_rabbit, "Indie Rock", 22.99, 13.79, "2008", "https://is2-ssl.mzstatic.com/image/thumb/Music123/v4/53/79/37/53793762-eeef-8cce-96b2-6de1c18740e2/source/600x600bb.jpg", 0, fat_cat)
album_repository.save(midnight)

# # Hozier Albums
wasteland = Album("Wasteland, Baby!", hozier, "Soul", 24.99, 14.99, "2019", "https://is4-ssl.mzstatic.com/image/thumb/Music114/v4/b8/61/a2/b861a286-5b7a-4827-b3e3-0875a8a554e2/source/600x600bb.jpg", 3, island)
album_repository.save(wasteland)

hozier_self_titled = Album("Hozier", hozier, "Folk Rock", 24.99, 14.99, "2014", "https://is5-ssl.mzstatic.com/image/thumb/Music118/v4/70/eb/5d/70eb5d85-7386-3d55-1d33-ac9400601a6b/source/600x600bb.jpg", 2, island)
album_repository.save(hozier_self_titled)


# # Janelle Monáe Album
dirty_computer = Album("Dirty Computer", janelle, "Funk/ R&B", 21.99, 13.19, "2018", "https://is2-ssl.mzstatic.com/image/thumb/Music118/v4/f4/58/47/f4584702-bd77-52c3-f7e0-fa05f4e80397/source/600x600bb.jpg", 1, atlantic)
album_repository.save(dirty_computer)

# # Leonard Cohen Albums
thanks_for_the_dance = Album("Thanks for the Dance", leonard_cohen, "Folk Rock", 20.00, 12.00, "2019", "https://is5-ssl.mzstatic.com/image/thumb/Music123/v4/81/e4/7c/81e47c3d-596a-bb52-e44d-ed6d681fbec1/source/600x600bb.jpg", 5, columbia)
album_repository.save(thanks_for_the_dance)

darker = Album("You Want it Darker", leonard_cohen, "Folk Rock", 20.00, 12.00, "2016", "https://is3-ssl.mzstatic.com/image/thumb/Music62/v4/29/0f/e7/290fe7f2-3176-6300-3d3f-6d2946fb8fbf/source/600x600bb.jpg", 9, columbia)
album_repository.save(darker)

future = Album("The Future", leonard_cohen, "Soft Rock", 20.00, 12.00, "1992", "https://is2-ssl.mzstatic.com/image/thumb/Music1/v4/4e/54/5c/4e545cdc-b314-c38b-0839-0796cf70bcc3/source/600x600bb.jpg", 3, columbia)
album_repository.save(future)

your_man = Album("I'm Your Man", leonard_cohen, "Soft Rock", 20.00, 12.00, "1988", "https://is5-ssl.mzstatic.com/image/thumb/Music3/v4/47/03/7c/47037cbd-48ef-4a7a-d4aa-f43ce3e82135/source/600x600bb.jpg", 0, columbia)
...
# Lizzo Album
love_you = Album("Cuz I Love You", lizzo, "Soul/ Hip-Hop", 23.99, 14.39, "2019", "https://is3-ssl.mzstatic.com/image/thumb/Music123/v4/15/83/ad/1583adac-3f2e-050c-d5d6-6879a865cb5d/source/600x600bb.jpg", 5, atlantic)
album_repository.save(love_you)

# Maggie Rogers Album
past_life = Album("Heard it in a Past Life", maggie_rogers, "Folk Pop", 19.99, 11.99, "2019", "https://is5-ssl.mzstatic.com/image/thumb/Music128/v4/47/ec/46/47ec4695-ab8f-3be8-6ca5-5e4c2ba599b1/source/600x600bb.jpg", 3, capitol)
album_repository.save(past_life)


# Paramore Albums
after_laughter = Album("After Laughter", paramore, "Pop Rock", 17.99, 10.79, "2017", "https://is1-ssl.mzstatic.com/image/thumb/Music91/v4/b5/d7/94/b5d794e2-e67d-2be9-373e-6410c82437cc/source/600x600bb.jpg", 4, fueled_by_ramen)
album_repository.save(after_laughter)

paramore_self_titled = Album("Paramore", paramore, "Pop Rock", 17.99, 10.79, "2013", "https://is3-ssl.mzstatic.com/image/thumb/Music/v4/8b/45/51/8b4551f9-563c-57db-c611-a16f8574b181/source/600x600bb.jpg", 0, fueled_by_ramen)
album_repository.save(paramore_self_titled)

brand_new_eyes = Album("Brand New Eyes", paramore, "Pop Rock", 17.99, 10.79, "2009", "https://is3-ssl.mzstatic.com/image/thumb/Music62/v4/5d/db/33/5ddb3338-b808-ffee-4bd6-263b655a33ba/source/600x600bb.jpg", 2, fueled_by_ramen)
album_repository.save(brand_new_eyes)

riot = Album("Riot!", paramore, "Alt-Rock", 17.99, 10.79, "2007", "https://is2-ssl.mzstatic.com/image/thumb/Music/v4/03/25/62/032562e5-4eed-2dce-46e8-6c5591aa30c7/source/600x600bb.jpg", 1, fueled_by_ramen)
album_repository.save(riot)

falling = Album("All We Know is Falling", paramore, "Alt-Rock", 17.99, 10.79, "2005", "https://is5-ssl.mzstatic.com/image/thumb/Music/v4/f2/3e/8e/f23e8ea6-7071-090c-afeb-da363a0466a1/source/600x600bb.jpg", 1, fueled_by_ramen)
album_repository.save(falling)

# Phoebe Bridgers Albums
punisher = Album("Punisher", phoebe_bridgers, "Indie Rock", 21.99, 13.19, "2020", "https://is3-ssl.mzstatic.com/image/thumb/Music113/v4/55/5d/c8/555dc8e0-32f1-0a53-ad7a-422244d9f75e/source/600x600bb.jpg", 6, dead_oceans)
album_repository.save(punisher)

stranger = Album("Stranger in the Alps", phoebe_bridgers, "Indie Rock", 21.99, 13.19, "2017", "https://is4-ssl.mzstatic.com/image/thumb/Music127/v4/2b/58/db/2b58dbdc-4450-b270-946f-8fc0aa27b88f/source/600x600bb.jpg", 5, dead_oceans)
