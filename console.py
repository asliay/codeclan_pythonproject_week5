...
making_movies = Album("Making Movies", dire_straits, rock, 22.99, 14.99, "1980", "https://is2-ssl.mzstatic.com/image/thumb/Music128/v4/d0/42/9e/d0429ee1-5338-c369-1aa2-b290ad655072/source/600x600bb.jpg", 2, vertigo, 16)
album_repository.save(making_movies)

# # Fleetwood Mac Albums 
tango = Album("Tango in the Night", fleetwood_mac, pop_rock, 20.00, 12.00, "1987", "https://is3-ssl.mzstatic.com/image/thumb/Music111/v4/28/a6/a9/28a6a9f9-7040-37e3-cef9-ef6f8ecaabfa/source/600x600bb.jpg", 4, warner, 7)
album_repository.save(tango)

mirage = Album("Mirage", fleetwood_mac, soft_rock, 18.00, 13.00, "1982", "https://is2-ssl.mzstatic.com/image/thumb/Music18/v4/30/5e/e2/305ee2d4-1520-4490-cd46-2336009989b1/source/600x600bb.jpg", 0, warner, 5)
album_repository.save(mirage)

tusk = Album("Tusk", fleetwood_mac, rock, 20.00, 12.00, "1979", "https://is2-ssl.mzstatic.com/image/thumb/Music19/v4/2f/39/8d/2f398d29-996a-0800-6640-4d2e8680a30d/source/600x600bb.jpg", 2, warner, 2)
album_repository.save(tusk)

rumours = Album("Rumours", fleetwood_mac, folk_rock, 19.00, 14.00, "1977", "https://is2-ssl.mzstatic.com/image/thumb/Music/v4/8e/75/28/8e752885-66d0-737c-11ef-4c706672997e/source/600x600bb.jpg", 5, warner, 19)
album_repository.save(rumours)

fleetwood_self_titled = Album("Fleetwood Mac", fleetwood_mac, soft_rock, 23.99, 17.45, "1975", "https://cdn.shopify.com/s/files/1/2976/0132/products/3749712_540x.jpg?v=1598653825", 3, warner, 3)
album_repository.save(fleetwood_self_titled)

# # Frightened Rabbit Albums
panic_attack = Album("Painting of a Panic Attack", frightened_rabbit, indie_rock, 21.99, 13.19, "2016", "https://is2-ssl.mzstatic.com/image/thumb/Music69/v4/a7/28/c5/a728c5a3-d583-e646-5eaa-0ad2b3b85d41/source/600x600bb.jpg", 6, atlantic, 5)
album_repository.save(panic_attack)

pedestrian = Album("Pedestrian Verse", frightened_rabbit, indie_rock, 19.99, 11.99, "2013", "https://is1-ssl.mzstatic.com/image/thumb/Music/v4/fc/9e/24/fc9e2421-bc95-29cd-4fe4-d0d570c22c84/source/600x600bb.jpg", 1, atlantic, 2)
album_repository.save(pedestrian)

midnight = Album("Midnight Organ Fight", frightened_rabbit, indie_rock, 22.99, 13.79, "2008", "https://is2-ssl.mzstatic.com/image/thumb/Music123/v4/53/79/37/53793762-eeef-8cce-96b2-6de1c18740e2/source/600x600bb.jpg", 0, fat_cat, 20)
album_repository.save(midnight)

# # Hozier Albums
wasteland = Album("Wasteland, Baby!", hozier, folk_rock, 24.99, 14.99, "2019", "https://is4-ssl.mzstatic.com/image/thumb/Music114/v4/b8/61/a2/b861a286-5b7a-4827-b3e3-0875a8a554e2/source/600x600bb.jpg", 3, island, 3)
album_repository.save(wasteland)

hozier_self_titled = Album("Hozier", hozier, folk_rock, 24.99, 14.99, "2014", "https://is5-ssl.mzstatic.com/image/thumb/Music118/v4/70/eb/5d/70eb5d85-7386-3d55-1d33-ac9400601a6b/source/600x600bb.jpg", 2, island, 2)
album_repository.save(hozier_self_titled)


# # Janelle Monáe Album
dirty_computer = Album("Dirty Computer", janelle, funk, 21.99, 13.19, "2018", "https://is2-ssl.mzstatic.com/image/thumb/Music118/v4/f4/58/47/f4584702-bd77-52c3-f7e0-fa05f4e80397/source/600x600bb.jpg", 1, atlantic, 18)
album_repository.save(dirty_computer)

# # Leonard Cohen Albums
thanks_for_the_dance = Album("Thanks for the Dance", leonard_cohen, folk_rock, 20.00, 12.00, "2019", "https://is5-ssl.mzstatic.com/image/thumb/Music123/v4/81/e4/7c/81e47c3d-596a-bb52-e44d-ed6d681fbec1/source/600x600bb.jpg", 5, columbia, 10)
...
# Lizzo Album
love_you = Album("Cuz I Love You", lizzo, soul_hop, 23.99, 14.39, "2019", "https://is3-ssl.mzstatic.com/image/thumb/Music123/v4/15/83/ad/1583adac-3f2e-050c-d5d6-6879a865cb5d/source/600x600bb.jpg", 5, atlantic, 18)
album_repository.save(love_you)

# Maggie Rogers Album
past_life = Album("Heard it in a Past Life", maggie_rogers, folk_pop, 19.99, 11.99, "2019", "https://is5-ssl.mzstatic.com/image/thumb/Music128/v4/47/ec/46/47ec4695-ab8f-3be8-6ca5-5e4c2ba599b1/source/600x600bb.jpg", 3, capitol, 10)
album_repository.save(past_life)


# Paramore Albums
after_laughter = Album("After Laughter", paramore, pop_rock, 17.99, 10.79, "2017", "https://is1-ssl.mzstatic.com/image/thumb/Music91/v4/b5/d7/94/b5d794e2-e67d-2be9-373e-6410c82437cc/source/600x600bb.jpg", 4, fueled_by_ramen, 17)
album_repository.save(after_laughter)

paramore_self_titled = Album("Paramore", paramore, pop_rock, 17.99, 10.79, "2013", "https://is3-ssl.mzstatic.com/image/thumb/Music/v4/8b/45/51/8b4551f9-563c-57db-c611-a16f8574b181/source/600x600bb.jpg", 0, fueled_by_ramen, 2)
...
stranger = Album("Stranger in the Alps", phoebe_bridgers, indie_rock, 21.99, 13.19, "2017", "https://is4-ssl.mzstatic.com/image/thumb/Music127/v4/2b/58/db/2b58dbdc-4450-b270-946f-8fc0aa27b88f/source/600x600bb.jpg", 5, dead_oceans, 7)
album_repository.save(stranger)

# Sara Bareilles Albums
chaos =  Album("Amidst the Chaos", sara, pop, 21.99, 13.19, "2019", "https://is2-ssl.mzstatic.com/image/thumb/Music114/v4/83/8a/0f/838a0f1b-84c0-377a-8823-bc49027ef9f3/source/600x600bb.jpg", 3, epic, 7)
album_repository.save(chaos)

blessed_unrest = Album("The Blessed Unrest", sara, pop, 21.99, 13.19, "2013", "https://is3-ssl.mzstatic.com/image/thumb/Music118/v4/dd/9f/9d/dd9f9d3c-cce9-4378-6223-f1a5b92fdc55/source/600x600bb.jpg", 2, epic, 8)
album_repository.save(blessed_unrest)

kaleidoscope = Album("Kaleidoscope Heart", sara, pop, 21.99, 13.19, "2010", "https://is2-ssl.mzstatic.com/image/thumb/Music128/v4/bc/2d/b0/bc2db0d9-6209-177b-80fc-afe38683b815/source/600x600bb.jpg", 1, epic, 1)
album_repository.save(kaleidoscope)

# Tallest Man on Earth Album

fever_dream = Album("I Love You. It's a Fever Dream.", tallest_man, folk, 17.99, 10.79, "2019", "https://is5-ssl.mzstatic.com/image/thumb/Music113/v4/8f/3d/f9/8f3df9cf-b15d-883c-7cef-fe2b6c69de5a/source/600x600bb.jpg", 2, dead_oceans, 12)
album_repository.save(fever_dream)

# Beyonce Albums

lemonade = Album("Lemonade", beyonce, rb, 21.99, 13.19, "2016", "https://is4-ssl.mzstatic.com/image/thumb/Music113/v4/50/a5/82/50a582f9-6690-ec06-14e7-e55d0d72e648/source/600x600bb.jpg", 3, columbia, 15)
album_repository.save(lemonade)
beyonce_self_titled = Album("Beyoncé", beyonce, rb, 19.99, 11.99, "2013", "https://is2-ssl.mzstatic.com/image/thumb/Music6/v4/17/84/3a/17843a6d-1f2b-7e1e-a39f-3ff865110993/source/600x600bb.jpg", 4, columbia, 7)
album_repository.save(beyonce_self_titled)

# Dermot Kennedy Album

without_fear = Album("Without Fear", dermot_kennedy, folk_pop, 19.99, 11.99, "2019", "https://is1-ssl.mzstatic.com/image/thumb/Music123/v4/72/26/4d/72264d37-4ae0-a1d2-73e3-e5e3413845fe/source/600x600bb.jpg", 1, island, 3)
album_repository.save(without_fear)

# Spider-Verse soundtrack
spiderverse = Album("Spider-Man: Into the Spider-Verse", various, hip_hop, 19.99, 11.99, "2018", "https://is4-ssl.mzstatic.com/image/thumb/Music124/v4/36/9b/a2/369ba2e1-2dfc-6e2a-7065-4612af58fa0a/source/600x600bb.jpg", 2, republic, 13)
album_repository.save(spiderverse)

# Rage Against the Machine album
rage_self_titled = Album("Rage Against the Machine", rage, rap_metal, 21.99, 13.19, "1992", "https://is3-ssl.mzstatic.com/image/thumb/Music113/v4/c8/2c/46/c82c46dc-eab8-4b62-1381-c2fae3d9b7a0/source/600x600bb.jpg", 1, epic, 2)
