...
kendrick = Artist("Kendrick Lamar")
artist_repository.save(kendrick)
...
artist_repository.save(vulfpeck)
...
endings = Album("A Celebration of Endings", biffy, "Alternative Rock", 24.99, 14.99, "2020", 7, fourteenth)
album_repository.save(endings)
ellipsis = Album("Ellipsis", biffy, "Alternative Rock", 19.99, 11.99, "2016", 8, fourteenth)
album_repository.save(ellipsis)
opposites = Album("Opposites", biffy, "Alternative Rock", 22.99, 13.79, "2013", 9, fourteenth)
album_repository.save(opposites)
revolutions = Album("Only Revolutions", biffy, "Alternative Rock", 19.99, 11.99, "2009", 5, fourteenth)
album_repository.save(revolutions)
puzzle = Album("Puzzle", biffy, "Alternative Rock", 27.99, 16.79, "2007", 3, fourteenth)
...
panic_attack = Album("Painting of a Panic Attack", frightened_rabbit, "Indie Rock", 21.99, 13.19, "2016", 15, atlantic)
